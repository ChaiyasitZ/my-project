...
SSH โดยใช้การเชื่อมต่อ ผ่านทาง Console Port และสามารถทำการตั้งค่าต่าง ๆ โดยผู้ใช้สามารถกรอก
 ค่าเพื่่อให้ตรงกับความต้องการได้ 
    ...
    \begin{mycustomenum2}
        ...
        \item สามารถเลือกอุปกรณ์ที่ต้องการจะ Config ได้ (รองรับการเลือกหลายอุปกรณ์พร้อมกันในโหมด CLI ด้วย Checkbox)
        \vspace{4em}
    ...
    \begin{mycustomenum2}
        ...
        \item มี Dashboard แสดงผล
            \begin{mycustomenum2}
                ...
                \item Backup type ประเภทของ Backup ได้แก่ Manual
...
%ระบุขอบเขตของโปรเจ็ค
\begin{mycustomenum2}
    \item พัฒนาเว็บแอปพลิเคชันให้รองรับการเชื่อมต่อ NETCONF Client
    \begin{mycustomenum2}
...
\begin{mycustomenum}[label=1.4.\arabic*] %เพิ่มวัตถุประสงค์หลัง \item ถ้ามีหลายข้อ ก็เพิ่มบรรทัด \item ไปได้เรื่อยๆ
    \item เพิ่มความรวดเร็วในการบริหารจัดการอุปกรณ์เครือข่าย ผ่าน Web Application ที่ออกแบบให้ใช้งานง่าย
    ...
    \item ช่วยให้การตัดสินใจและวางแผนการดูแลเครือข่ายแม่นยำและตรวจสอบย้อนหลังได้ 
\end{mycustomenum}
