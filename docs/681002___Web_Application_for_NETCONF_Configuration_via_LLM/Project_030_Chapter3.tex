...
\begin{mycustomitem2}
    ...
    \item \textbf{Process 3.0 Configuration Generation:} สร้าง Configuration อัตโนมัติด้วย AI (Ollama LLM) โดยรับ Prompt ภาษาธรรมชาติ แล้วสร้าง CLI หรือ NETCONF/YANG XML สำหรับอุปกรณ์ NX-OS System และ IOS-XE native
...
\hspace*{1.3em} %ย่อหน้า
ระบบมี Data Store ทั้งหมด 7 ตาราง ได้แก่ D1 Users, D2 Devices, D3 Configs, D4 Backups, D5 YANG Models, D6 Agent Commands และ D7 Shell Sessions โดยมี External Entities ได้แก่ ผู้ใช้ (Network Admin), Google OAuth, Ollama LLM, Desktop Agent และอุปกรณ์เครือข่าย
