...
\begin{mycustomitem2}
    ...
    \item \textbf{Console Relay:} ระบบตรวจจับ SerialPort availability (\texttt{serialPortAvailable} flag) เพื่อ Relay คำสั่ง Console ไปยัง Desktop Agent อัตโนมัติบน Vercel Serverless ที่ไม่สามารถใช้ Native Module ได้
