...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|} 
        ...
        \hline
        5 & BackupSchedule & เก็บตารางเวลาการสำรองคอนฟิกอัตโนมัติ \\
        \hline
        6 & YangModel & จัดเก็บข้อมูล YANG Model ที่ใช้สำหรับ NETCONF Configuration \\
        \hline
    \end{tabularx}
\end{table}
...
% =====================================================
% Table: BackupSchedule Structure
% =====================================================
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|} 
        ...
        \multicolumn{1}{|c|}{\textbf{ฟิลด์}} & \multicolumn{1}{c|}{\textbf{ประเภท}} & \multicolumn{1}{c|}{\textbf{คำอธิบาย}} \\
        \hline
        \_id & ObjectId & รหัสตารางเวลา (Primary Key) \\
        \hline
        userId & ObjectId & รหัสผู้ใช้ (Foreign Key $\rightarrow$ User) \\
        \hline
        device\_id & ObjectId & รหัสอุปกรณ์ (Foreign Key $\rightarrow$ Device) \\
        \hline
        schedule\_name & String(255) & ชื่อตารางเวลา (Required) \\
        \hline
        frequency & Enum & ความถี่: daily, weekly, monthly \\
        \hline
        day\_of\_week & Number & วันในสัปดาห์ (0-6, สำหรับ weekly) \\
        \hline
        day\_of\_month & Number & วันในเดือน (1-31, สำหรับ monthly) \\
        \hline
        time & String & เวลาที่ทำ Backup (HH:mm format) \\
        \hline
        config\_type & Enum & ประเภท: running-config, startup-config, both \\
        \hline
        is\_active & Boolean & สถานะการใช้งาน (default: true) \\
        \hline
        retention\_count & Number & จำนวน Backup ที่เก็บไว้ (default: 10) \\
        \hline
        last\_run & Date & เวลาที่ทำ Backup ล่าสุด \\
        \hline
        next\_run & Date & เวลาที่จะทำ Backup ครั้งถัดไป \\
        \hline
        last\_status & Enum & สถานะล่าสุด: success, failed, pending \\
        \hline
        last\_error & String & ข้อผิดพลาดล่าสุด (ถ้ามี) \\
        \hline
        createdAt & Date & วันที่สร้าง (Auto) \\
        \hline
        updatedAt & Date & วันที่แก้ไข (Auto) \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|l|X|} 
        ...
        \hline
        User & BackupSchedule & One-to-Many & ผู้ใช้หนึ่งคนมีตารางเวลาสำรองได้หลายรายการ \\
        \hline
        ...
        \hline
        Device & BackupSchedule & One-to-Many & อุปกรณ์หนึ่งตัวมีตารางเวลาสำรองได้หลายรายการ \\
        \hline
        ConfigurationBackup & ConfigurationHistory & One-to-Many & Backup หนึ่งรายการสามารถอ้างอิงได้หลาย History \\
        \hline
        BackupSchedule & ConfigurationBackup & One-to-Many & ตารางเวลาหนึ่งรายการสามารถสร้าง Backup ได้หลายรายการ \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|} 
        ...
        \hline
        BackupSchedule & (userId, device\_id) & ค้นหาตารางเวลาตามผู้ใช้และอุปกรณ์ \\
        \hline
        BackupSchedule & (is\_active, next\_run) & กรองตารางเวลาที่กำลังทำงาน \\
        \hline
        BackupSchedule & next\_run & ค้นหาตารางเวลาถัดไป \\
        \hline
