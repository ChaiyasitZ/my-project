\appendixChapterTitle{จ}{กระบวนการทำงานของ Desktop Agent}
\vspace*{-0.8in}
...
\adjustbox{frame, width=1.0\textwidth}{
    \includegraphics[width=1.0\textwidth]{Image/agent-1.png}
}
\caption{\fontSixTeen{หน้าตัวอย่างของ Desktop Agent}}
\label{figB:Ollama1}
\end{figure}
...
\hspace*{1.3em}
ทุก HTTP Request ที่ Agent ส่งจะแนบ Header \textbf{X-Agent-Token} สำหรับยืนยันตัวตน โดย Token นี้ได้มาจากการสร้างที่หน้า Agent Setting ผ่านหน้าเว็บแอปพลิเคชัน
