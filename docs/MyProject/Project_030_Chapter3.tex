...
\begin{figure}[H]
    \centerline{\includegraphics[width=1.2\textwidth]{Image/Level-0.png}}
    \caption{\fontSixTeen{DFD Main Process}}
    \label{fig3:Level-0}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\fontSixTeen{DFD ของ Main Process 1.0 (Authentication)}}
\label{fig3:DataflowDiagram}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=\textwidth]{Image/Level-2.png}}
    \caption{\fontSixTeen{DFD ของ Main Process 2.0 (Device Management)}}
    \label{fig3:DataflowDiagram_Level2_Process1.0}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=1.0\textwidth]{Image/Level-3.png}}
    \caption{\fontSixTeen{DFD ของ Main Process 3.0 ( Config Generator)}}
    \label{fig3:DataflowDiagram_Level2_Process2.0}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=1.0\textwidth]{Image/Level-4.png}}
    \caption{\fontSixTeen{DFD ของ Main Process 4.0 (Deployment)}}
    \label{fig3:DataflowDiagram_Level2_Process3.0}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=1.0\textwidth]{Image/Level-5.png}}
    \caption{\fontSixTeen{DFD ระดับที่ 2 ของ Main Process (Backup Management)}}
    \label{fig3:DataflowDiagram_Level2_Process4.0}
\end{figure}

\begin{figure}[H]
    \centerline{\includegraphics[width=1.0\textwidth]{Image/Level-6.png}}
