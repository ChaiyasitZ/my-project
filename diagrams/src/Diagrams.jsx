...
function DFDLevel1() {
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-6 overflow-x-auto">
      ...
      <div className="relative min-w-[1100px] h-[920px] mx-auto">
        <svg className="absolute inset-0 w-full h-full" style={{ zIndex: 1 }}>
          ...
          <line x1="265" y1="100" x2="205" y2="780" stroke="#A855F7" strokeWidth="1" strokeDasharray="4,3" markerEnd="url(#arrowL1)" />
          <text x="218" y="440" className="text-[9px] fill-purple-500 dark:fill-purple-400" transform="rotate(-85, 218, 440)">User CRUD</text>
          
          <line x1="295" y1="220" x2="355" y2="780" stroke="#A855F7" strokeWidth="1" strokeDasharray="4,3" markerEnd="url(#arrowL1)" />
          ...
          <text x="540" y="555" className="text-[10px] fill-cyan-600 dark:fill-cyan-400">Interactive SSH</text>
          <line x1="700" y1="480" x2="345" y2="685" stroke="#06B6D4" strokeWidth="1.5" markerEnd="url(#arrowL1)" />
          <text x="505" y="598" className="text-[10px] fill-cyan-600 dark:fill-cyan-400">Shell Output</text>
          
          {/* 6.0 → D7 Shell Sessions */}
          <line x1="290" y1="705" x2="290" y2="780" stroke="#A855F7" strokeWidth="1" strokeDasharray="4,3" markerEnd="url(#arrowL1)" />
          <text x="310" y="750" className="text-[9px] fill-purple-500 dark:fill-purple-400">Shell I/O</text>
        </svg>
        ...
        <div className="absolute left-[240px] top-[655px]">
          <div className="w-[105px] h-[50px] rounded-lg bg-violet-500 dark:bg-violet-600 flex flex-col items-center justify-center shadow-md">
            <span className="text-xs font-bold text-white">6.0</span>
            <span className="text-[10px] text-white text-center">Console Mgmt</span>
          </div>
        </div>
        
        {/* Data Stores - Bottom Row */}
        <div className="absolute left-[100px] top-[810px]">
        ...
        <div className="absolute left-[220px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
        ...
        <div className="absolute left-[340px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
        ...
        <div className="absolute left-[460px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
        ...
        <div className="absolute left-[570px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
        ...
        <div className="absolute left-[670px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
        ...
        <div className="absolute left-[790px] top-[810px]">
          <div className="flex items-stretch">
            <div className="w-8 bg-white dark:bg-gray-800 border-t-2 border-b-2 border-l-2 border-purple-600 dark:border-purple-500 flex items-center justify-center">
              <span className="font-bold text-xs text-purple-600 dark:text-purple-400">D7</span>
            </div>
            <div className="border-2 border-purple-600 dark:border-purple-500 bg-white dark:bg-gray-800 px-3 py-2">
              <span className="text-xs font-medium text-gray-800 dark:text-white">Sessions</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
            ...
            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
              ...
              <td className="px-4 py-3 text-gray-600 dark:text-gray-400">Interactive SSH shell via Agent Relay → Desktop Agent, polling-based I/O buffer</td>
              <td className="px-4 py-3 text-gray-500">Device ID, Shell commands</td>
              <td className="px-4 py-3 text-gray-500">Shell output, Session status</td>
            </tr>
          </tbody>
        </table>
      </div>
