...
function ConsoleConfiguration() {
  ...
  const fetchAvailablePorts = async () => {
    ...
    try {
      ...
      if (ports.length === 0) {
        toast('No serial ports detected. Please connect a USB-to-Serial cable and click Refresh.', { icon: 'ℹ️' });
      }
    } catch (error) {
      ...
      if (error.code === 'ECONNABORTED' || error.message?.includes('timeout')) {
        toast.error('Port scan timed out. Please ensure the NetConfig Agent is running.');
      } else {
        toast.error(msg || 'Could not reach agent. Please ensure the NetConfig Agent is running.');
      }
    } finally {
